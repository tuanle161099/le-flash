...
class LeFlashProgram {
    constructor(provider, programId) {
        ...
        this.fetchCheques = () => __awaiter(this, void 0, void 0, function* () {
        ...
        this.deposit = ({ recipient = this._provider.wallet.publicKey.toBase58(), poolAddress, sendAndConfirm = true, mintNFTAddress, chequeKeypair = anchor_1.web3.Keypair.generate(), }) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.closeCheque = ({ chequeAddress, sendAndConfirm = true, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            const tx = yield this.program.methods
                .closeCheque()
                .accounts(Object.assign({ authority: this._provider.wallet.publicKey, cheque: chequePubkey }, PROGRAMS))
                .transaction();
            let txId = '';
            console.log(tx, 'tx');
            if (sendAndConfirm) {
